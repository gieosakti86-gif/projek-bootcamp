...
<body
    class="bg-[#F8FAFC] text-slate-800 antialiased selection:bg-blue-300 selection:text-blue-900 min-h-screen flex flex-col overflow-x-hidden">

    <!-- Responsive Modern Navbar -->
    <nav
        class="bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-950 text-white shadow-xl sticky top-0 z-50 border-b border-blue-800/40 backdrop-blur-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-20">
                ...
                <div class="flex items-center space-x-2 sm:space-x-3">
                    <div
                        class="bg-gradient-to-tr from-blue-500 to-indigo-400 text-white p-2 sm:p-2.5 rounded-xl sm:rounded-2xl shadow-lg shadow-blue-500/30 border border-blue-400/30">
                        <i data-lucide="link" class="w-5 h-5 sm:w-6 sm:h-6"></i>
                    </div>
                    <div class="flex flex-col">
                        <span
                            class="font-extrabold text-lg sm:text-xl tracking-tight bg-gradient-to-r from-white via-blue-100 to-blue-300 bg-clip-text text-transparent">BioLink</span>
                        <span
                            class="hidden sm:block text-[10px] text-blue-300 font-semibold uppercase tracking-widest leading-none mt-0.5">Dashboard
                            Panel</span>
                    </div>
                </div>
