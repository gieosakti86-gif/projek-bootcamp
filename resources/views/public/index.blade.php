...
<head>
    ...
    .bg-grid-pattern {
        ...
        background-image:url('{{ asset("rider.jpg") }}'),
...
<body class="bg-grid-pattern min-h-screen font-sans antialiased text-slate-900 pb-20">
    ...
    <main class="max-w-md mx-auto pt-12 px-4 flex flex-col items-center relative">
        ...
        <div class="relative mb-6">
            <div
                ...
                <img src="LOGO.png" alt="Profile Avatar" class="w-full h-full object-cover">
            </div>
        </div>

        <h1 class="text-xl font-black mb-2 text-center tracking-tight">@GioSport</h1>

        <p class="text-center text-sm font-extrabold px-6 mb-6">
            Jual beli mobilmotor mevvah murmerrr <br>
            <span class="text-blue-700 font-black">Mobil</span> (Suv & Sport) •
            <span class="text-sky-700 font-black">Motor</span> (600-1000 cc) •
        </p>
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <a href="#" aria-label="Direct Email"
                class="p-2 bg-white rounded-full border-2 border-slate-900 shadow-[2px_2px_0px_0px_#0f172a] hover:-translate-y-1 transition-transform"><i
        ...
        <div id="modal-content"
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b-2 border-dashed border-blue-200 pb-4">
                    ...
                    <p class="font-extrabold text-sm truncate">madmadmad@gmail.com</p>
                </div>
                <div class="flex items-center gap-3 border-b-2 border-dashed border-blue-200 pb-4">
            ...
            <div
                ...
                <p class="text-[11px] font-bold text-slate-700 leading-relaxed">
                    Apabila peramban Anda tidak mendukung pengunduhan berkas VCF secara otomatis, silakan salin kontak
                    secara manual.
                </p>
            </div>
    ...
    function openModal() {
        ...
        // Menjadwalkan penambahan kelas CSS pada frame animasi berikutnya
