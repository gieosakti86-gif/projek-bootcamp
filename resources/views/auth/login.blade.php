...
<body class="bg-grid-pattern min-h-screen font-sans antialiased flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md px-4">
        ...
        <div class="text-center mb-8">
            <div
                class="w-16 h-16 bg-amber-200 border-4 border-slate-900 rounded-2xl flex items-center justify-center shadow-[4px_4px_0px_0px_#0f172a] mx-auto mb-4">
        ...
        <div class="bg-white border-4 border-slate-900 rounded-3xl p-6 sm:p-8 shadow-[8px_8px_0px_0px_#0f172a]">
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
                ...
                @if($errors->any())
                <div
                    class="bg-rose-200 border-2 border-slate-900 p-4 rounded-xl flex items-start gap-3 shadow-[2px_2px_0px_0px_#0f172a]">
                ...
                <div class="pt-2">
                    <button type="submit"
                        class="w-full bg-blue-400 hover:bg-blue-300 text-slate-950 font-extrabold py-3.5 rounded-xl border-2 border-slate-900 shadow-[4px_4px_0px_0px_#0f172a] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all flex items-center justify-center gap-2">
